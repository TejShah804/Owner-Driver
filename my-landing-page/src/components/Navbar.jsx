      ...
      {menuOpen && (
        <div className="lg:hidden bg-brand-navy px-6 pt-4 pb-8 flex flex-col gap-5 shadow-xl">
          ...
          <button 
            ...
            className="block w-full text-center px-5 py-3 rounded-full bg-brand-orange text-white text-base font-semibold hover:bg-orange-500 transition-colors cursor-pointer mt-2"
          >
            Register Interest
          </button>
        </div>
