...
const testimonials = [
  {
    quote: "Migrating our critical payment infrastructure to OwnerDC was the best technology decision we've made in a decade. Downtime has been effectively zero, and their NOC team treated our servers like they were their own.",
  ...
  {
    quote: "We evaluated every major colocation provider in Australia before choosing OwnerDC. The combination of Tier III certification, genuine carrier neutrality, and on-site technical expertise is unmatched. Three years in, they've exceeded every expectation.",
    name: "Sarah Chen",
  ...
  {
    quote: "OwnerDC's direct cloud connectivity has transformed how we deliver applications to our clients. The latency improvements are measurable, and the reliability gives us confidence to offer SLAs we couldn't previously guarantee.",
    name: "Michael Torres",
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10" ref={ref}>
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-xl mx-auto">
            Hear from the enterprise teams who trust us with their most critical systems.
          </p>
        </motion.div>
        ...
        >
          <div
            ...
            style={{ boxShadow: "0 8px 60px rgba(0,174,239,0.08)" }}
              ...
              {testimonials.map((_, i) => (
                <button
                  ...
                  className={`h-2 rounded-full transition-all duration-300 ${
                    i === active ? "bg-primary w-8" : "bg-white/20 w-2 hover:bg-white/40"
                  }`}
                />
              ))}
            </div>
