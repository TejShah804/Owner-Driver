...
const solutions = [
  {
    ...
    description: "Bring your own hardware and place it in our purpose-built, carrier-neutral facilities. Get all the benefits of world-class infrastructure without the capital expense of building your own data centre.",
    benefits: [
  ...
  },
  {
    tag: "Cloud",
    title: "Cloud On-Ramp",
    description: "Connect directly to AWS, Azure, Google Cloud, and Oracle Cloud via dedicated private circuits — bypassing the public internet entirely for maximum performance, security, and predictable latency.",
    benefits: [
  ...
  },
  {
    ...
    description: "Hand over the day-to-day complexity to our certified engineering team. From server provisioning and OS patching to 24/7 monitoring and incident response — we keep your infrastructure running so you don't have to.",
    benefits: [
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10" ref={ref}>
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Whether you're starting with a single rack or migrating your entire data centre, we have a solution that fits.
          </p>
        </motion.div>
          ...
          {solutions.map((solution, i) => (
            ...
            >
              ...
              <div className={i % 2 === 1 ? "lg:col-start-2" : ""}>
                ...
                <h3 className="text-3xl font-extrabold text-white mb-4">{solution.title}</h3>
                <p className="text-muted-foreground leading-relaxed mb-7">{solution.description}</p>
              ...
              <div className={`relative ${i % 2 === 1 ? "lg:col-start-1 lg:row-start-1" : ""}`}>
                <div className="relative bg-card border border-white/8 rounded-2xl p-8 h-64 lg:h-80 overflow-hidden"
                  style={{ boxShadow: "0 4px 40px rgba(0,174,239,0.08)" }}>
                  ...
                  <div className="relative z-10 h-full flex flex-col justify-between">
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">
                          {i === 0 ? "Uptime Guarantee" : i === 1 ? "Cloud Latency" : "Expert Support"}
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {(i === 0
                        ? [["4,200+", "Racks"], ["30 MW", "Power"], ["20+", "Carriers"]]
                        : i === 1
                        ? [["4", "Cloud Providers"], ["100G", "Bandwidth"], ["Dual", "Redundant"]]
                        : [["15+", "Years Exp."], ["500+", "Clients"], ["<15min", "Response"]]
                      ).map(([val, label]) => (
