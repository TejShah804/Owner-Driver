...
const items = [
  {
    title: "Drivers",
    content: "Manage work with clear visibility of hours, limits, and changes throughout the day.",
  },
  {
    title: "Fleet Operators",
    content: "Allocate and manage work with visibility of hours, constraints, and compliance as the day unfolds.",
  },
  {
    title: "Shippers",
    content: "Engage carriers with greater transparency over allocation, compliance exposure, and operational status.",
  },
  {
    title: "Compliance & Safety Teams",
    content: "Monitor work, records, and emerging risk with a clear operational view, not retrospective reporting.",
  },
];
...
export default function WhoItsFor() {
  ...
  return (
    <section className="bg-brand-navy py-16 md:py-20 lg:py-28" id="who-its-for">
                ...
                return (
                  <div
                    ...
                    className={`border-l-2 transition-colors duration-200 ${
                      isOpen ? "border-brand-orange" : "border-transparent"
                    }`}
                  >
                    <button
                      type="button"
